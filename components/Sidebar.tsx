...
import { MdDashboard, MdShoppingCart, MdCategory, MdHome, MdClose, MdDiscount, MdBrandingWatermark, MdSettings } from 'react-icons/md';
...
const navItems = [
  ...
  { label: 'الاعدادات', href: '/settings', icon: MdSettings }
];
